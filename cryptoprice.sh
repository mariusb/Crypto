...
curl -s 'https://min-api.cryptocompare.com/data/pricemulti?fsyms=BTC,ETH,LTC,DASH,DOGE,BTG,TRX,SC,BCH,OMG,CVC,DCR,XVG,XMR,ADA,USDT,USDC&tsyms=USD' >> cryptoprice.data 
echo "" >> cryptoprice.data
curl -s 'https://min-api.cryptocompare.com/data/pricemulti?fsyms=ADA,TRX,DOGE,SHIB,XMR,LTC,XLM,BNB,DASH,ETH,USDT,USDC&tsyms=BTC' >> cryptoprice.data 
echo "" >> cryptoprice.data
