...
echo "" >> cryptoprice.data
curl -s 'https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,ethereum,dogecoin,tron,cardano,night,blockdag,tether,usd-coin&vs_currencies=usd&x_cg_demo_api_key=CG-6ECawTrFcx92rJg7UrgtXUjb' >> cryptoprice.data
echo "" >> cryptoprice.data
